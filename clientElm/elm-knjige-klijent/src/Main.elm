...
update msg model =
    case msg of
        ...
        MsgInputPagesFieldAsString newPages ->
            ( { model | bookPages = Maybe.withDefault 0 (String.toInt newPages) }, Cmd.none )    --JOS JE BOLJE DA SE RAZLOZI NA SLUCAJEVE I POSEBNO OBRADE UMJESTO Maybe.withDefault
        ...
        MsgInputLanguageIdFieldAsString newLanguageId ->
            ( { model | bookLanguageId = Maybe.withDefault 0 (String.toInt newLanguageId) }, Cmd.none )   --JOS JE BOLJE DA SE RAZLOZI NA SLUCAJEVE I POSEBNO OBRADE UMJESTO Maybe.withDefault
        ...
        MsgInputIdFieldAsString newId ->
            ( { model | bookId = Maybe.withDefault 1 (String.toInt newId) }, Cmd.none )   --JOS JE BOLJE DA SE RAZLOZI NA SLUCAJEVE I POSEBNO OBRADE UMJESTO Maybe.withDefault
        ...
        MsgSuccesfulPost result ->
            ...
            case result of
                Ok data ->
                    ( { newModel | errorMessage = Nothing }, Cmd.none )--poruka = data, errorMessage = Nothing }, Cmd.none )
...
viewAddBookButton = viewButtonGeneric "Add Book" MsgAddBook
...
viewGetBooksHaskellButton = viewButtonGeneric "Haskell" MsgGetBooksHaskell

viewGetBooksElixirButton : E.Element Msg
viewGetBooksElixirButton = viewButtonGeneric "Elixir" MsgGetBooksElixir

viewGetBooksFsharpButton : E.Element Msg
viewGetBooksFsharpButton = viewButtonGeneric "F#" MsgGetBooksFsharp

viewGetBooksClojureButton : E.Element Msg
viewGetBooksClojureButton = viewButtonGeneric "Clojure" MsgGetBooksClojure

viewGetBooksOcamlButton : E.Element Msg
viewGetBooksOcamlButton = viewButtonGeneric "OCaml" MsgGetBooksOcaml

viewGetBooksScalaButton : E.Element Msg
viewGetBooksScalaButton = viewButtonGeneric "Scala" MsgGetBooksScala

viewGetBooksRacketButton : E.Element Msg
viewGetBooksRacketButton = viewButtonGeneric "Racket" MsgGetBooksRacket
...
viewGetBooksAPLButton = viewButtonGeneric "APL" MsgGetBooksAPL

viewGetBooksMirandaButton : E.Element Msg
viewGetBooksMirandaButton = viewButtonGeneric "Miranda" MsgGetBooksMiranda

viewGetBooksAgdaButton : E.Element Msg
viewGetBooksAgdaButton = viewButtonGeneric "Agda" MsgGetBooksAgda
